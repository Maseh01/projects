        ...
        <div className="container page-padding py-[10rem]">
          ...
          <div className="flex gap-6 w-full mt-[5rem] md1200:justify-center flex-wrap">
            ...
            <BlogBox
              bgClass="box3Bg"
              date="28.06.2024"
              title="Meet Fitness Ambassador Joy"
              description="Get to know Joy, a fitness enthusiast and dedicated ambassador who is passionate about helping others reach their fitness goals."
            />
          </div>
        </div>
      </section>
